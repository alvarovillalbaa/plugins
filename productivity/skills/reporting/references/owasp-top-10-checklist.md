...
Comprehensive reference for each OWASP Top 10 category with descriptions, test procedures, code patterns, remediation steps, and CVSS scoring guidance.
...
|---|------|--------|-----------------|
| 1 | Horizontal privilege escalation | Change user ID in API requests (`/users/123` → `/users/124`) | 403 Forbidden |
...
|---|---|---|
| Horizontal escalation (read) | 6.5 | AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:N/A:N |
| Horizontal escalation (write) | 8.1 | AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:N |
| Vertical escalation to admin | 8.8 | AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H |
| Unauthenticated admin access | 9.8 | AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H |
...
Failures related to cryptography that often lead to sensitive data exposure. Includes using weak algorithms, improper key management, and transmitting data in cleartext.
...
| Scenario | Score | Vector |
|---|---|---|
| Cleartext transmission of passwords | 7.5 | AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N |
| Weak password hashing (MD5) | 7.5 | AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N |
| Hardcoded encryption key | 7.2 | AV:N/AC:L/PR:H/UI:N/S:U/C:H/I:H/A:H |
...
| Scenario | Score | Vector |
|---|---|---|
| SQL injection (unauthenticated) | 9.8 | AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H |
...
Insecure design represents weaknesses in the design and architecture of the application, distinct from implementation bugs. Includes missing or ineffective security controls.
...
| Scenario | Score | Vector |
|---|---|---|
| Missing rate limit on auth | 7.5 | AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N |
| Business logic bypass (financial) | 8.1 | AV:N/AC:L/PR:L/UI:N/S:U/C:N/I:H/A:H |
...
| Scenario | Score | Vector |
|---|---|---|
| Debug mode in production | 5.3 | AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:N/A:N |
| Default admin credentials | 9.8 | AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H |
...
For automated dependency scanning, use a current advisory-backed tool for the
project's ecosystem and attach its dated output as evidence. Do not rely on a
bundled static CVE snapshot.
...
| Scenario | Score | Vector |
|---|---|---|
| Authentication bypass | 9.8 | AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H |
| Session fixation | 7.5 | AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N |
| Username enumeration | 5.3 | AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:N/A:N |
...
| Scenario | Score | Vector |
|---|---|---|
| Unsafe deserialization (RCE) | 9.8 | AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H |
| Missing SRI on CDN scripts | 6.1 | AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:N |
...
For SSRF payloads and bypass techniques, see [references/attack-patterns.md](../../../../engineering/skills/web-vuln-validation/references/attack-patterns.md#ssrf-detection-techniques).
...
| Scenario | Score | Vector |
|---|---|---|
| SSRF to cloud metadata (credential theft) | 9.1 | AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:N |
| SSRF to internal service (read) | 7.5 | AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N |
| Blind SSRF (no response data) | 5.3 | AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:N/A:N |
