---
name: customer-qual-research
description: >-
  Use for customer qualitative research, interviews, themes, ICP learning,
  pain synthesis, and evidence-backed product or GTM insight. Child skill of
  `research`; route here from the parent router when this lane is the
  narrowest owner.
---

# Customer Qual Research

This child skill owns customer qualitative research, interviews, themes, ICP learning, pain synthesis, and evidence-backed product or GTM insight. It carries the detailed assets for this lane after the corrected fragmentation split.

## Use When

- The request is primarily about customer qualitative research, interviews, themes, ICP learning, pain synthesis, and evidence-backed product or GTM insight.
