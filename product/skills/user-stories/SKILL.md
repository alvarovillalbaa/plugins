...
name: user-stories
description: >-
  Use for user stories, acceptance criteria, epic breakdown, story point
  estimation, sprint planning, and Definition of Done. Child skill of
  `product-development`; route here from the parent router when this lane is
  the narrowest owner.
---
