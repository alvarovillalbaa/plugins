...
Four copy frameworks with worked SaaS examples you can adapt. Each framework includes a complete before/after example plus specific guidelines for each section. See `references/landing-page-generation.md` for how to select the right framework based on brand voice.
...
### Promise
- Make a clear, specific, believable promise tied to a measurable outcome
- Example: "Reduce customer churn by 25% in 90 days"

### Picture
- Help the reader visualize success with scenarios they can relate to
- Show the product in context (screenshots, demos)

### Proof
- Back the promise with customer testimonials with specific results, case studies with before/after metrics, and third-party validation (awards, analyst reports)

### Push
- Give a compelling reason to act now: limited-time offer, bonus, or guarantee
