...
- Use `../../../../engineering/skills/onboarding-flows/references/signup-onboarding-flows.md` when the request shifts to browser implementation details, states, instrumentation, or accessibility.
