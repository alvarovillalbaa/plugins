...
- Use `../../../../engineering/skills/onboarding-flows/references/signup-onboarding-flows.md` when the user needs implementation rules for checklist UI, tours, empty states, resume flows, or instrumentation.
