...
4. **Hard cut deliberately** — Breaking changes need a canonical owner, focused proof, and docs; do not add compatibility component facades by default

### Interaction Reference

Use the `fluid-functionalism` reference source when interaction-style detail is needed. This local reference records when to consult it, not the source-owned style rules themselves.
...
- [critique.md](../../critique/references/design-critique.md) — Reviewing Figma designs or screenshots (five-dimension framework)
- [pre-shipping-polish.md](../../polish/references/pre-shipping-polish.md) — Final quality pass once a component is built
