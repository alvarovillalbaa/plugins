...
50+ mental models for understanding buyer behavior, influencing decisions ethically, and building more effective marketing systems.

**Check for product marketing context first:** If `.agents/product-marketing-context.md` exists (or `.claude/product-marketing-context.md`), read it before applying these models to tailor recommendations to the specific product and audience.
...
### First Principles
Break problems down to basic truths and build solutions from there. Use the 5 Whys technique to find root causes instead of copying competitors.
...
A local optimum is the best solution nearby; a global optimum is the best overall. Don't get stuck optimizing the wrong thing.
...
### Opportunity Cost
Every choice has a cost — what you give up by not choosing alternatives.
...
### Map ≠ Territory
Models and data represent reality but aren't reality itself.
...
Losses feel roughly twice as painful as equivalent gains feel good. People work harder to avoid losing than to gain.
