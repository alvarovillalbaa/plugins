---
name: polish
description: Use for UI polish, visual defects, layout fit, spacing, states, motion, interaction finish, and screenshot-based cleanup. Child of `design`.
---
...
- `redesign-skill`: Use redesign guidance for improving existing UI without broad product drift. Install: `python3 scripts/install-external-skills.py --skill redesign-skill --agent codex`.
