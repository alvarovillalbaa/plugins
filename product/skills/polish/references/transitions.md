...
For Fluid Functionalism details, use the `fluid-functionalism` reference source. Keep this local file focused on project-owned transition implementation notes.
