...
description: >-
  Use for design review, UX critique, visual hierarchy, interaction risk,
  accessibility observations, and polish recommendations. Child skill of
  `review`; route here from the parent router when this lane is the
  narrowest owner.
---
