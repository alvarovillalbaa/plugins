# Technical SEO Audit — Output Templates

Detailed output templates for technical SEO audit steps 3-9. Referenced from [SKILL.md](../SKILL.md) (discoverability skill).
