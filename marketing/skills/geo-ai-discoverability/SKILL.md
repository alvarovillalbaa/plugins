...
description: >-
  ...
  visibility, and AI search content structure. Child skill of `seo-and-geo`;
  route here from the parent router when this lane is the narrowest owner.
---

# GEO AI Discoverability

This child skill owns GEO and AI discoverability, quotable blocks, citation readiness, LLM visibility, and AI search content structure. It carries the detailed assets for this lane after the corrected fragmentation split.
