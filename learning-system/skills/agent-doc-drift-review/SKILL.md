---
name: agent-doc-drift-review
description: >-
  Use for agent documentation drift review, instruction-file audits, stale doc
  detection, and owner-doc update recommendations. Child skill of `auto-
  improve`; route here from the parent router when this lane is the
  narrowest owner.
---
