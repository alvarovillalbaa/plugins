...
name: knowledge-base
description: >-
  Use for knowledge-base improvement, dedupe proposals, canonical page health,
  missing source promotion, and knowledge drift repair. Child skill of
  `skills-management`; route here from the parent router when this lane is the
  narrowest owner.
---
