...
Use skill: **reconciliation** — `skills/reconciliation/SKILL.md`. Chain to **fiscal-close** only when the requested period-close workflow requires it.
...
This command matches and explains historical records. It does not build forecasts or commit ledger changes without exact authorization.
