---
name: cicd
description: Use for cloud deployment strategy, CI/CD wiring, OIDC or managed identity, rollout gates, and deploy automation. Child of `cloud`.
---
...
- `clous-cli-integration`: Use Clous-owned CLI integration guidance for command-line workflows. Install: `python3 scripts/install-external-skills.py --skill clous-cli-integration --agent codex`.
- `clous-cli-use`: Use Clous-owned CLI usage guidance for platform command-line operations. Install: `python3 scripts/install-external-skills.py --skill clous-cli-use --agent codex`.
