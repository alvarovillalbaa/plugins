...
### `.skill-improvements/[run-id]/[reference-name]-improved.md`
The optimized version of the reference file. The original stays untouched until the user reviews the bundle.

### `.skill-improvements/[run-id]/[reference-name]-changelog.md`
...
### `.skill-improvements/[run-id]/[reference-name]-results.json`
