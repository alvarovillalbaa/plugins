...
| [examples.md#rest-api-testing](examples.md#rest-api-testing) | REST API test examples |
| [examples.md#graphql-testing](examples.md#graphql-testing) | GraphQL test examples |
