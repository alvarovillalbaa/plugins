...
Use this reference when the task is to design a target architecture before provisioning. It consolidates the AWS, Azure, and GCP architecture workflows into one cloud operating model.
