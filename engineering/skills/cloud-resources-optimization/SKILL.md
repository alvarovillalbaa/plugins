---
name: cloud-resources-optimization
description: >-
  Use for cloud inventory, cost optimization, resource sizing, waste cleanup,
  lifecycle policy, and utilization analysis. Child skill of `cloud-
  management`; route here from the parent router when this lane is the
  narrowest owner.
---

# Cloud Resources Optimization

This child skill owns cloud inventory, cost optimization, resource sizing, waste cleanup, lifecycle policy, and utilization analysis. It carries the detailed assets for this lane after the corrected fragmentation split.
