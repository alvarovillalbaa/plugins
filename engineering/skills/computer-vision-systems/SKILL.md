...
description: >-
  Use for computer vision architectures, detection, segmentation, video
  inference, model optimization, and production deployment. Child skill of
  `ai-engineering`; route here from the parent router when this lane is the
  narrowest owner.
---
